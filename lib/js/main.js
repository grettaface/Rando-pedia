...
function populateFavorites(){
    ...
    var tempArray = favoriteArray.reverse();

    $.each(favoriteArray, function(index, item){
        favList += "<div class='favorite'><div class='favTitle' onclick='getArticleContent(\""+item.title+"\","+item.id+")'>"+item.title+"</div><div class='removeFavorite icon-close'></div></div><div class='clear'></div>"
    });
