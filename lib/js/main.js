...
function populateFavorites(){
    ...
    $.each(tempArray, function(index, item){
        favList += "<div class='favorite'><div class='favTitle' onclick='getArticleContent(\""+item.title+"\","+item.id+")'>"+item.title+"</div><div class='removeFavorite icon-close' onclick='updateFavorites(\"remove\",\"null\","+item.id+")'></div></div><div class='clear'></div>"
    });
